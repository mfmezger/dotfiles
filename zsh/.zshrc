...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    source_if_exists /usr/share/zsh/plugins/zsh-abbr/zsh-abbr.zsh || \
        source_if_exists "${ZSH_CUSTOM:-$HOME/.oh-my-zsh/custom}/plugins/zsh-abbr/zsh-abbr.zsh"
...
if (( $+functions[_zsh_autosuggest_strategy_abbreviations] )); then
    ZSH_AUTOSUGGEST_STRATEGY=( abbreviations $ZSH_AUTOSUGGEST_STRATEGY )
fi
export LANG=en_US.UTF-8

export EDITOR="nvim"
HAS_ABBR=$(( $+functions[abbr] || $+commands[abbr] ))
...
source_if_exists "$DOTFILES_DIR/zsh/zellij_title.zsh"
