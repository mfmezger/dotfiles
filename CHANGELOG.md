...
- **update**: introducing update and setting uu as deprecated
- **brew**: removing htop, and building a comparing script
- **coderoaster**: adding code roaster agent
- **zsh**: add lt (tree) and lg (git) abbreviations for eza

### Refactor

- **scripts**: consolidate backup_if_exists function into scripts/common.sh
- **chore**: clean CHANGELOG to remove duplicate v0.36.0 entries
- **cz**: fix commitizen tag format from "$version" to "v$version"
